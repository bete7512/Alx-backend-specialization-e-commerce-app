<template>
    <div
        ...
        <div class="relative h-[50%]">
            ...
            <button @click="managefavorite(product.id, product.is_favorite)"
                ...
                <div class="flex justify-center  pt-1 pl-3">
                    <svg v-if="product.is_favorite" style="color: red" xmlns="http://www.w3.org/2000/svg" width="26"
        ...
        <div class="p-5 h-[50%]">
            ...
            <div class="flex justify-between py-3">
                <StarRating v-model:rating="product.average_rate" :read-only="true" :increment="0.001" :star-size="12">
                </StarRating>
                <div class="flex space-x-1 items-center">
                    <!-- -->
                    <button  @click="managelikes(product.id, product.is_liked)">
                        <svg v-if="product.is_liked" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                    ...
                    <div class="text-xs">Helpfull({{ product.number_of_likes }})</div>
                </div>
            </div>
