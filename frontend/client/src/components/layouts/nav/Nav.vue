                ...
                <div>
                    <div class="flex relative justify-center items-center space-x-3 ">
                        ...
                        <div class="relative sm:w-96 md:96 ">
                            ...
                            <button type="submit"
                                class="text-white absolute right-0 bottom-0 top-0 bg-orange-600 hover:bg-blue-800  focus:outline-none focus:ring-blue-300 font-medium   rounded-r-lg  text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
                        </div>
