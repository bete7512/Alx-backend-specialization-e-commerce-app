<template>
  <div class="fixed w-screen bg-white z-50">
    <div
      class="flex container bg-red-400 mx-auto justify-center items-center z-50"
    >
      <div
        class="flex justify-between container items-center text-black bg-[#ffffff] px-10 h-20"
      >
