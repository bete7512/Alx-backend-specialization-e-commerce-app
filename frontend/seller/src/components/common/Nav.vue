  ...
  <div class="space-x-0 w-full z-10 flex justify-between">
    ...
    <div class="w-full flex-1 bg-slate-200">
          ...
          <div class="relative">
            ...
            >
              ...
              >
                ...
                <button
                  @click="logout"
                  class="flex justify-center px-4 py-2 text-sm text-gray-700 hover:bg-indigo-600 hover:text-white"
                >
                  Log out
                </button>
              </div>
      ...
      <div class="w-full lg:pl-72 pl-0 h-screen right-0 mt-20">
        <div
          class="sm:w-1/6 w-full sm:px-0 px-5 h-28 lg:pl-16 pl-5 pt-5 space-x-2 mt-4 rounded-lg"
        >
